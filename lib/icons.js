...
{
    name: 'Vite',
    icon: () => <TechLogo src={viteLogoSrc} width="65px" />,
    config: {
        color: '#0984e3',
        size: '65px'
    },
...
{
    name: 'Figma',
    icon: () => <TechLogo src={figmaLogoSrc} width="65px" />,
    config: {
        color: '#0984e3',
        size: '65px'
    },
...
{
    name: 'Web3.js',
    icon: () => <TechLogo src={web3jsLogoSrc} width="65px" />,
    config: {
        color: '#ffffff',
        size: '65px'
    },
...
{
    name: 'Ethers.js',
    icon: () => <TechLogo src={ethersjsLogoSrc} width="65px" />,
    config: {
        color: '#ffffff',
        size: '65px'
    },
...
{
    name: 'Hardhat',
    icon: () => <TechLogo src={hardhatLogoSrc} width="65px" />,
    config: {
        color: '#ffffff',
        size: '65px'
    },
...
{
    name: 'Ganache',
    icon: () => <TechLogo src={ganacheLogoSrc} width="65px" />,
    config: {
        color: '#ffffff',
        size: '65px'
    },
...
{
    name: 'Truffle',
    icon: () => <TechLogo src={truffleLogoSrc} width="65px" />,
    config: {
        color: '#ffffff',
        size: '65px'
    },
